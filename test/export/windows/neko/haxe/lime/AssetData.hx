...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			path.set ("assets/data/test.oep", "assets/data/test.oep");
			type.set ("assets/data/test.oep", Reflect.field (AssetType, "text".toUpperCase ()));
			...
			path.set ("assets/images/container - Copy.png", "assets/images/container - Copy.png");
			type.set ("assets/images/container - Copy.png", Reflect.field (AssetType, "image".toUpperCase ()));
